...
@if (count($book_data))
    <div class="alert alert-success">Ditemukan <strong>{{ count($book_data) }}</strong> data dengan kata kunci:
    ...
    <form action="{{ route('book.search') }}" method="get">
        @csrf
        <input type="text" name="word" class="form-control" placeholder="Cari ...."
...
@else
    <div class="alert alert-warning">
        <h4>Data {{ $search }} not found</h4><a href="/book" class="btn btn-warning">Back</a>
    </div>
@endif
